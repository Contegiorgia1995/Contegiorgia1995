...
import discretize_nonstationary_ar_rouwen
from discretize_nonstationary_ar_rouwen import discretize_nonstationary_ar_rouwen
...
# clear; clc; close all; 
    ...
    for ie in range (0,len(EDUC)): 
        ...
        for ia in range (age_start[ie],par.Jr_pos):
            ############################################################
            P, etagrid  =  discretize_nonstationary_ar_rouwen(inc_inno_rho[ie],inc_z_var[ie,ia-1]**0.5,inc_z_var[ie,ia]**0.5, N_markov)           
