function [m_data,m_title,inc] = moments_data
...
pos = 113; m_title{pos}   ='Mean H0                               '; inc(pos) = 0; m_id(pos) = pos;
...
pos = 119; m_title{pos}   ='IGE: Rank-Rank (100)'; inc(pos) = 0; m_id(pos) = pos; 
pos = 120; m_title{pos}   ='IGE: Rank-Rank (100)'; inc(pos) = 0; m_id(pos) = pos; 
pos = 121; m_title{pos}   ='IGE: Rank-Rank (100)'; inc(pos) = 0; m_id(pos) = pos; 
pos = 122; m_title{pos}   ='IGE: Rank-Rank (100)'; inc(pos) = 0; m_id(pos) = pos; 
pos = 123; m_title{pos}   ='IGE: Rank-Rank (100)'; inc(pos) = 0; m_id(pos) = pos; 
...
% Fertility
pos = 026; m_title{pos}   ='E(fertility$\mid$D01)                 '; inc(pos) = 0; m_id(pos) = pos;      
pos = 027; m_title{pos}   ='E(fertility$\mid$D02)                 '; inc(pos) = 0; m_id(pos) = pos;     
pos = 028; m_title{pos}   ='E(fertility$\mid$D03)                 '; inc(pos) = 0; m_id(pos) = pos;     
pos = 029; m_title{pos}   ='E(fertility$\mid$D04)                 '; inc(pos) = 0; m_id(pos) = pos;     
pos = 030; m_title{pos}   ='E(fertility$\mid$D05)                 '; inc(pos) = 0; m_id(pos) = pos;     
pos = 031; m_title{pos}   ='E(fertility$\mid$D06)                 '; inc(pos) = 0; m_id(pos) = pos;      
pos = 032; m_title{pos}   ='E(fertility$\mid$D07)                 '; inc(pos) = 0; m_id(pos) = pos;     
pos = 033; m_title{pos}   ='E(fertility$\mid$D08)                 '; inc(pos) = 0; m_id(pos) = pos;     
pos = 034; m_title{pos}   ='E(fertility$\mid$D09)                 '; inc(pos) = 0; m_id(pos) = pos;     
pos = 035; m_title{pos}   ='E(fertility$\mid$D10)                 '; inc(pos) = 0; m_id(pos) = pos;     
...
pos = 114; m_title{pos}   ='E(fertility$\mid$Q1)                 '; inc(pos) = 0; m_id(pos) = pos;      
pos = 115; m_title{pos}   ='E(fertility$\mid$Q2)                 '; inc(pos) = 0; m_id(pos) = pos;     
pos = 116; m_title{pos}   ='E(fertility$\mid$Q3)                 '; inc(pos) = 0; m_id(pos) = pos;     
pos = 117; m_title{pos}   ='E(fertility$\mid$Q4)                 '; inc(pos) = 0; m_id(pos) = pos;     
pos = 118; m_title{pos}   ='E(fertility$\mid$Q5)                 '; inc(pos) = 0; m_id(pos) = pos;     
...
pos = 126; m_title{pos}   ='Mean transfer: Par Educ 1          '; inc(pos) = 0; m_id(pos) = pos; 
pos = 127; m_title{pos}   ='Mean transfer: Par Educ 2          '; inc(pos) = 0; m_id(pos) = pos; 
pos = 128; m_title{pos}   ='Mean transfer: Par Educ 3          '; inc(pos) = 0; m_id(pos) = pos; 

pos = 129; m_title{pos}   ='Mean transfer: Child Educ 1          '; inc(pos) = 0; m_id(pos) = pos; 
pos = 130; m_title{pos}   ='Mean transfer: Child Educ 2          '; inc(pos) = 0; m_id(pos) = pos; 
pos = 131; m_title{pos}   ='Mean transfer: Child Educ 3          '; inc(pos) = 0; m_id(pos) = pos; 

pos = 132; m_title{pos}   ='Mean transfer: Parents Income Q1          '; inc(pos) = 0; m_id(pos) = pos; 
pos = 133; m_title{pos}   ='Mean transfer: Parents Income Q2          '; inc(pos) = 0; m_id(pos) = pos; 
pos = 134; m_title{pos}   ='Mean transfer: Parents Income Q3          '; inc(pos) = 0; m_id(pos) = pos; 
pos = 135; m_title{pos}   ='Mean transfer: Parents Income Q4          '; inc(pos) = 0; m_id(pos) = pos; 
pos = 136; m_title{pos}   ='Mean transfer: Parents Income Q5          '; inc(pos) = 0; m_id(pos) = pos; 

pos = 137; m_title{pos}   ='Mean transfer: Parents Savings Q1          '; inc(pos) = 0; m_id(pos) = pos; 
pos = 138; m_title{pos}   ='Mean transfer: Parents Savings Q2          '; inc(pos) = 0; m_id(pos) = pos; 
pos = 139; m_title{pos}   ='Mean transfer: Parents Savings Q3          '; inc(pos) = 0; m_id(pos) = pos; 
pos = 140; m_title{pos}   ='Mean transfer: Parents Savings Q4          '; inc(pos) = 0; m_id(pos) = pos; 
pos = 141; m_title{pos}   ='Mean transfer: Parents Savings Q5          '; inc(pos) = 0; m_id(pos) = pos;
...
pos = 124; m_title{pos}  ='Variance of log Lifetime Labor Income      '; inc(pos) = 0; m_id(pos) = pos; 
pos = 125; m_title{pos}  ='Variance of log Lifetime Earnings w/ Sav. Returns  '; inc(pos) = 0; m_id(pos) = pos; 
...
m_data([363 365]) = 1.1^4;
m_data([364 366]) = 1.1^4;
...
% m_data(100)   =  (30566/10000);

%% Fertility
% Mean fertility
m_data(6)   = 2.15;                      % CEB using CPS Fertility Supplement
m_data(19:21)   = [2.91 2.16 2.05]; 
...
% year 2000
m_data(336:338)   = [-.22 -0.17 -0.08];



% Fertility: IPUMS 
% % \\data\Data_US\Census\Results\All Years\Married Only, Highest income is
% head, Income higher than 8000\TFR_incl_Dropping_G10.csv --- year 2000
fert_q  = [5.607321
5.174753
5.025022
4.919501
...
m_data(114:118) = [mean(m_data(26:27)) mean(m_data(28:29)) mean(m_data(30:31)) mean(m_data(32:33)) mean(m_data(34:35))];
...
m_data(815:834) = [0.2899272	0.3135391	0.316031	0.3192114	0.3193045	0.3372735	0.3693489	0.3608962	0.3600198	0.3755267	0.3799404	0.3873558	0.390824	0.4196693	0.410549	0.4191138	0.4122302	0.4138614	0.4121634	0.458396];
m_data(838:857) = [0.2544554	0.2680113	0.27129	0.284426	0.2963256	0.3038086	0.3114513	0.3212118	0.3299431	0.3335335	0.3447733	0.3502299	0.3634748	0.3753273	0.3879678	0.4159468	0.4389367	0.4540344	0.476598	0.5155528];
m_data(861:880) = [0.2301561	0.2395292	0.2630498	0.2943045	0.3343467	0.36843	0.3858399	0.4001463	0.414575	0.4294064	0.4242073	0.4239349	0.4297636	0.4294264	0.4456645	0.48757	0.5362071	0.5656666	0.6358634	0.7077469];
...
% Mean of log income
m_data(907:926) = [10.12238	10.17661	10.2151	10.23823	10.25728	10.29128	10.34185	10.36962	10.35979	10.38943	10.39661	10.38761	10.4038	10.39274	10.41147	10.39992	10.39692	10.36404	10.33563	10.27561];
m_data(930:949) = [10.47148	10.56427	10.63978	10.6851	10.72024	10.76297	10.80317	10.82489	10.84396	10.85976	10.87067	10.87532	10.86983	10.85867	10.84794	10.79852	10.76079	10.68781	10.61354	10.50915];
m_data(953:972) = [10.7714	10.95236	11.07125	11.15056	11.20917	11.27506	11.32668	11.3496	11.37035	11.38507	11.38611	11.3864	11.38239	11.38717	11.39494	11.38166	11.33517	11.26623	11.1777	11.08602];
